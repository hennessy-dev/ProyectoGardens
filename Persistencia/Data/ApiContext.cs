...
public partial class ApiContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseMySql("name=ConnectionStrings:ConexMySql", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.34-mysql"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Cliente>(entity =>
        {
            ...
            entity.Property(e => e.LineaDireccionl)
                .HasMaxLength(50)
                .HasColumnName("linea_direccionl");
        ...
        modelBuilder.Entity<Empleado>(entity =>
        {
            ...
            entity.Property(e => e.Apellid02)
                .HasMaxLength(50)
                .HasColumnName("apellid02");
